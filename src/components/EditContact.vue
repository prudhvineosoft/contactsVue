    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="text-center error" v-if="this.error">
            {{ this.error }}
          </p>
          <div class="container d-flex justify-content-center">
            ...
            >
              ...
              <div class="group">
                ...
                <div class="text-center error" v-if="data.updatedData.error">
                  <div
                    v-for="my_error of data.updatedData.error"
                    :key="my_error"
                  >
                    <p
              ...
              <div class="group">
                ...
                <div class="text-center error" v-if="data.updatedData.error">
                  <div
                    v-for="my_errors of data.updatedData.error"
                    :key="my_errors"
                  >
                    <p
          ...
          <div class="modal-footer">
            ...
            <button type="submit" form="editContact" class="btn btn-primary">
              Edit Contact
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    submitEditForm: async function () {
      this.v$.$validate();
      if (!this.v$.$error) {
        await this.$store.dispatch("deleteModule/update_data", {
          id: this.contactId,
          formData: this.formData,
        });
        await this.$store.dispatch("getContactsModule/getContacts");
        if (!this.data.updatedData.err) {
    ...
    fromParent: function (id) {
      this.contactId = id;
      for (let contact of this.contacts["contactsList"]) {
        if (contact.id === id) {
          this.formData.name = contact.name;
          this.formData.email = contact.email;
          this.formData.mobile = contact.mobile;
          this.formData.company = contact.company;
          this.formData.type = contact.type;

          this.formData.image_path = contact.image_path;
        }
      }
    },
  },
